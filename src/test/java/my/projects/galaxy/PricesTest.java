...
public class PricesTest {
  ...
  public void exact() {
    ...
    assertThat(prices.totalFor("Gold", 4L), is(new BigDecimal("57800")));
  }
  ...
  public void multiple() throws Exception {
    ...
    assertThat(prices.totalFor("Silver", 4L), is(new BigDecimal("68")));
  }
  ...
  public void decimals() throws Exception {
    ...
    assertThat(prices.totalFor("Iron", 4L), is(new BigDecimal("782.0")));
  }
